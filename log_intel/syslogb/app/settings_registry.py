...
def registry() -> list[SettingDef]:
    return [
        ...
        SettingDef(
            ...
            "Service token ID for remote Ollama behind Cloudflare Access (CF-Access-Client-Id)",
        ),
        SettingDef(
            "CF_ACCESS_CLIENT_SECRET",
            "",
            ...
            "Service token secret (CF-Access-Client-Secret). Stored in SQLite, never shown again.",
        ),
