...
def registry() -> list[SettingDef]:
    return [
        ...
        SettingDef(
            ...
            "Optional. Only needed if Ollama is behind Cloudflare Access. Leave blank for local Ollama.",
        ),
        SettingDef(
            "CF_ACCESS_CLIENT_SECRET",
            "",
            ...
            "Optional. Service token secret for Access-protected Ollama. Leave blank for local Ollama, or leave blank on save to keep the current value.",
        ),
        ...
        SettingDef(
            ...
            "auth",
            "LDAP admin group DN",
            "Members may change settings, alerts, and run LLM jobs",
        ),
        SettingDef(
            "LDAP_ADMIN_GROUP_CN",
            "",
            ...
            "auth",
            "LDAP admin group CN",
            "Alternative to LDAP admin group DN",
        ),
        ...
        SettingDef(
            "LOG_INTEL_RESERVE_EVENTS_MIST",
            "1000",
            "int",
            "hub",
            "Minimum Mist events kept when trimming hub DB",
            "Protects cloud events when Palo traffic fills the store",
        ),
        SettingDef(
            "LOG_INTEL_RESERVE_EVENTS_PALO",
            "0",
            "int",
            "hub",
            "Minimum Palo Alto events kept when trimming (0 = no floor)",
        ),
