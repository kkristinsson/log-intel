...
CF_ACCESS_CLIENT_ID = _env("CF_ACCESS_CLIENT_ID", "")
CF_ACCESS_CLIENT_SECRET = _env("CF_ACCESS_CLIENT_SECRET", "")
...
LDAP_ADMIN_GROUP = _env("LDAP_ADMIN_GROUP", "")
LDAP_ADMIN_GROUP_CN = _env("LDAP_ADMIN_GROUP_CN", "")
