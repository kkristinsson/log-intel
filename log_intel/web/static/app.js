...
async function loadHealth() {
  ...
  add("syslogb", data.adapters?.syslogb?.ok ? "OK" : "N/A", data.adapters?.syslogb?.ok);
  add("loggy", data.adapters?.loggy?.ok ? "OK" : "N/A", data.adapters?.loggy?.ok);
  add("netsyslog", data.adapters?.netsyslog?.ok ? "OK" : "N/A", data.adapters?.netsyslog?.ok);
}
