...
- Pre-built binary → **`syslog-pusher/dist/SyslogPusher-0.9.2.exe`**
...
2. Deploy **`syslog-pusher/dist/SyslogPusher-0.9.2.exe`** on Windows hosts (or rebuild from `syslog-pusher/`).
